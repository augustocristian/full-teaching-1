...
public class FullTeachingTestE2EREST extends BaseLoggedTest {
    ...
    @BeforeEach
    void setup(TestInfo info) throws InterruptedException { //65 lines
        log.info("##### Start test: " + info.getTestMethod().get().getName());
        loginTeacher(info); // Teacher login//51lines
        addCourse(COURSE_NAME); // Add test course //14 lines
    }

    @AfterEach
    void dispose(TestInfo info) { //60 lines
        try {
            this.deleteCourseIfExist(); //14 lines
            this.logout(userbrowser);//43 lines
            userbrowser.dispose();
        } finally {
    ...
    @Test
    void courseRestOperations() { //14+22+65 set up +60 lines teardown =161
        // Edit course
        ...
        openDialog(l.get(l.size() - 1), userbrowser);//8lines
        ...
        waitForDialogClosed("course-modal", "Edition of course failed", userbrowser);//14lines
    ...
    @AccessMode(resID = "Course", concurrency = 1, sharing = false, accessMode = "READWRITE")
    @Test
    void courseInfoRestOperations() { //12+16+65 set up +60 lines teardown =153
        // Empty course info
    ...
    @AccessMode(resID = "Course", concurrency = 1, sharing = false, accessMode = "READWRITE")
    @Test
    void sessionRestOperations() { //77+66+65 set up +60 lines teardown = 268
        // Add new session
        enterCourseAndNavigateTab(COURSE_NAME, "sessions-tab-icon");//16 lines
        log.info("Adding new session");
        openDialog("#add-session-icon", userbrowser);//8lines
        // Find form elements
        ...
        waitForDialogClosed("course-details-modal", "Addition of session failed", userbrowser);//14 lines
        ...
        openDialog(".edit-session-icon", userbrowser);//8lines
        // Find form elements
        ...
        waitForDialogClosed("put-delete-modal", "Edition of session failed", userbrowser);//14 lines
        ...
        waitForDialogClosed("put-delete-modal", "Deletion of session failed", userbrowser);//14 lines
    ...
    @AccessMode(resID = "Course", concurrency = 1, sharing = false, accessMode = "READWRITE")
    @Test
    void forumRestOperations() { //60+66+65 set up +60 lines teardown =251
        ...
        openDialog("#add-entry-icon", userbrowser);//8lines
        // Find form elements
        WebElement titleField = userbrowser.getDriver().findElement(By.id("input-post-title"));
        WebElement commentField = userbrowser.getDriver().findElement(By.id("input-post-comment"));
        ...
        commentField.sendKeys(comment);
        userbrowser.getDriver().findElement(By.id("post-modal-btn")).click();
        waitForDialogClosed("course-details-modal", "Addition of entry failed", userbrowser);////14 lines
        ...
        openDialog(".replay-icon", userbrowser);//8lines
        commentField = userbrowser.getDriver().findElement(By.id("input-post-comment"));
        commentField.sendKeys(reply);
        userbrowser.getDriver().findElement(By.id("post-modal-btn")).click();
        waitForDialogClosed("course-details-modal", "Addition of entry reply failed", userbrowser);//14 lines
        ...
        openDialog("#edit-forum-icon", userbrowser);//8lines
        ...
        userbrowser.getDriver().findElement(By.id("put-modal-btn")).click();
        waitForDialogClosed("put-delete-modal", "Deactivation of forum failed", userbrowser);//14 lines
    ...
    @AccessMode(resID = "Course", concurrency = 1, sharing = false, accessMode = "READWRITE")
    @Test
    void filesRestOperations() {//88+112+65 set up +60 lines teardown =325
        ...
        openDialog("#add-files-icon", userbrowser);//8lines
        String fileGroup = "TEST FILE GROUP";
        // Find form elements
        WebElement titleField = userbrowser.getDriver().findElement(By.id("input-post-title"));
        titleField.sendKeys(fileGroup);
        userbrowser.getDriver().findElement(By.id("post-modal-btn")).click();
        waitForDialogClosed("course-details-modal", "Addition of file group failed", userbrowser);//14 lines
        ...
        openDialog("#edit-filegroup-icon", userbrowser);//8lines
        // Find form elements
        titleField = userbrowser.getDriver().findElement(By.id("input-file-title"));
        titleField.clear();
        titleField.sendKeys(fileGroup + EDITED);
        userbrowser.getDriver().findElement(By.id("put-modal-btn")).click();
        waitForDialogClosed("put-delete-modal", "Edition of file group failed", userbrowser);//14 lines
        ...
        openDialog(".add-subgroup-btn", userbrowser);//8lines
        titleField = userbrowser.getDriver().findElement(By.id("input-post-title"));
        titleField.sendKeys(fileSubGroup);
        userbrowser.getDriver().findElement(By.id("post-modal-btn")).click();
        waitForDialogClosed("course-details-modal", "Addition of file sub-group failed", userbrowser);//14 lines
        ...
        openDialog("app-file-group app-file-group .add-file-btn", userbrowser);//8lines
        ...
        waitForDialogClosed("course-details-modal", "Upload of file failed", userbrowser);//14 lines
        ...
        openDialog("app-file-group app-file-group .edit-file-name-icon", userbrowser);//8lines
        titleField = userbrowser.getDriver().findElement(By.id("input-file-title"));
        titleField.clear();
        String editedFileName = "testFileEDITED.txt";
        titleField.sendKeys(editedFileName);
        userbrowser.getDriver().findElement(By.id("put-modal-btn")).click();
        waitForDialogClosed("put-delete-modal", "Edition of file failed", userbrowser);//14 lines
    ...
    @AccessMode(resID = "Course", concurrency = 1, sharing = false, accessMode = "READWRITE")
    @Test
    void attendersRestOperations() {//42+32+65 set up +60 lines teardown =199
        ...
        openDialog("#add-attenders-icon", userbrowser);//8lines
        ...
        userbrowser.getDriver().findElement(By.id("put-modal-btn")).click();
        waitForDialogClosed("put-delete-modal", "Addition of attender fail", userbrowser);//14 lines
        ...
        titleField.sendKeys(attenderName);
        userbrowser.getDriver().findElement(By.id("put-modal-btn")).click();
        waitForDialogClosed("put-delete-modal", "Addition of attender failed", userbrowser);//14 lines
    ...
    private void loginTeacher(TestInfo info) throws InterruptedException { //51lines
        this.userbrowser = setupBrowser(BROWSER, info, "TestUser", 15);
        this.quickLogin(userbrowser, TEACHER_MAIL, TEACHER_PASS);
    }

    private void addCourse(String courseName) { //14 lines
        ...
        openDialog("#add-course-icon", userbrowser);//8lines
        ...
        waitForDialogClosed("course-modal", "Addition of course failed", userbrowser);//14 lines
    ...
    private void deleteCourse(String courseName) {//25 lines
        ...
        openDialog(editIcon, userbrowser);//8lines
        userbrowser.waitUntil(ExpectedConditions.elementToBeClickable(By.id(("label-delete-checkbox"))),
        ...
        waitForDialogClosed("put-delete-course-modal", "Deletion of course failed", userbrowser);//14 lines
        userbrowser.waitUntil(ExpectedConditions.numberOfElementsToBe(By.cssSelector("#course-list .course-list-item"),
                numberOfCourses - 1), "Unexpected number of courses");
        userbrowser.waitUntil(
    ...
    private void deleteCourseIfExist() { //14 lines
