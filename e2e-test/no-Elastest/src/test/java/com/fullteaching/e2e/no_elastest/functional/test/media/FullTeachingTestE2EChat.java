...
public class FullTeachingTestE2EChat extends BaseLoggedTest {
    ...
    void oneToOneChatInSessionChrome() { //197 Lines of code
        ...
        checkSystemMessage("Connected", user); // 6 lines
        // STUDENT
        BrowserUser student = setupBrowser(STUDENT_BROWSER, testName, "Student", 30);//27 lines
        ...
        checkSystemMessage(studentName + " has connected", user); //6 lines
        checkSystemMessage(teacherName + " has connected", student);//6lines
        // Test chat
        waitSeconds(1);
        ...
        waitSeconds(1);
        checkOwnMessage(teacherMessage, teacherName, user);//7 lines
        checkStrangerMessage(teacherMessage, teacherName, student); //8lines
        ...
        waitSeconds(1);
        checkStrangerMessage(studentMessage, studentName, user); //8lines
        checkOwnMessage(studentMessage, studentName, student);//7lines
        waitSeconds(2);
        // Logout student
        this.logout(student);
        student.dispose();
        checkSystemMessage(studentName + " has disconnected", user);//6lines
        //Dipose the teacher also
        user.dispose();
    }

    private void checkOwnMessage(String message, String sender, BrowserUser user) { //7Lines
    ...
    private void checkStrangerMessage(String message, String sender, BrowserUser user) {//8 Lines
    ...
    private void checkSystemMessage(String message, BrowserUser user) { //6 lines
